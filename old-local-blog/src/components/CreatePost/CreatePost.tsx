...
import { addPost, cancelEditingPost, finishEditingPost } from 'src/pages/Blog/blog.reducer'
...
export default function CreatePost() {
  ...
  const postEditing = useSelector<RootState>((state) => state.blog.editingPost)
  ...
  useEffect(() => {
    if (postEditing) {
      setFormData(postEditing as PostType)
      return
    }
    setFormData(initialState)
  }, [postEditing])
